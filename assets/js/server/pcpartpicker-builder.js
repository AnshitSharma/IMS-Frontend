...
*/
    ...
    scrollToComponent(type) {
        ...
        if (element) {
            ...
            // Highlight briefly
            element.style.backgroundColor = 'var(--color-primary-lightest, #CCFBF1)';
...
style.textContent = `
    ...
    .progress-bar {
        width: 100%;
        height: 8px;
        background: var(--color-surface-secondary, #E2E8F0);
        border-radius: 4px;
        overflow: hidden;
    ...
    .progress-fill {
        height: 100%;
        background: linear-gradient(90deg, var(--color-success, #22C55E), var(--color-warning, #EAB308));
